...
***************************************************************************
*                                                                         *
* Scale each matrix column. Column 1 by sx, 2 by sy, and 3 by sz.         *
*                                                                         *
*  |  m11*sx  m12*sy  m13*sz  |                                           *
*  |  m21*sx  m22*sy  m23*sz  |                                           *
*  |  m31*sx  m32*sy  m33*sz  |                                           *
*  |  m41*sx  m42*sy  m43*sz  |                                           *
*                                                                         *
***************************************************************************
...
CatScaleMat   	START
               ...
               ldx   ScaleX+2
               jsr   FixFixMul
               mv4   Result+2,matrix+m11

               mv4   matrix+m21,Arg1
               lda   ScaleX
               ldx   ScaleX+2
               jsr   FixFixMul
               mv4   Result+2,matrix+m21

               mv4   matrix+m31,Arg1
               lda   ScaleX
               ldx   ScaleX+2
               jsr   FixFixMul
               mv4   Result+2,matrix+m31

               mv4   matrix+m41,Arg1
               lda   ScaleX
               ldx   ScaleX+2
               jsr   FixFixMul
               mv4   Result+2,matrix+m41

           	mv4   matrix+m12,Arg1
               lda   ScaleY
               ldx   ScaleY+2
               jsr   FixFixMul
               mv4   Result+2,matrix+m12

               mv4   matrix+m22,Arg1
               lda   ScaleY
               ldx   ScaleY+2
               jsr   FixFixMul
               mv4   Result+2,matrix+m22

               mv4   matrix+m32,Arg1
               lda   ScaleY
               ldx   ScaleY+2
               jsr   FixFixMul
               mv4   Result+2,matrix+m32

               mv4   matrix+m42,Arg1
               lda   ScaleY
               ldx   ScaleY+2
               jsr   FixFixMul
               mv4   Result+2,matrix+m42

           	mv4   matrix+m13,Arg1
               lda   ScaleZ
               ldx   ScaleZ+2
               jsr   FixFixMul
               mv4   Result+2,matrix+m13

               mv4   matrix+m23,Arg1
               lda   ScaleZ
               ldx   ScaleZ+2
               jsr   FixFixMul
               mv4   Result+2,matrix+m23

               mv4   matrix+m33,Arg1
               lda   ScaleZ
               ldx   ScaleZ+2
               jsr   FixFixMul
               mv4   Result+2,matrix+m33

               mv4   matrix+m43,Arg1
               lda   ScaleZ
               ldx   ScaleZ+2
               jsr   FixFixMul
               mv4   Result+2,matrix+m43
...
TransformLoop  lda   |0,y
               and   #$FF               ;=0 if more vertices
               beq   TransformPnt
	rts

TransformPnt   sty   pnts
               mv2   "|pntoy,y",oldy
               mv2   "|pntoz,y",oldz
;
...
***************************************************************************
*                                                                         *
* Multiply a fixed-point number by an integer version 2                   *
* Input: A = integer, Arg1 = Fixed                                        *
*                                                                         *
* This is a fast version that only returns the bottom 2 words (fixed)     *
*                                                                         *
***************************************************************************
...
***************************************************************************
*                                                                         *
* Multiply two integers version 2                                         *
* Input: A = Arg1, X = Arg2                                               *
* Ouput: Result contains result                                           *
*                                                                         *
* This version does not return Result+2                                   *
*                                                                         *
***************************************************************************
