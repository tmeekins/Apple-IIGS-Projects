...
; Compress the data
;
               Packbytes (#start,#length,#data,#160*62),PackLen
;
...
SplashStr      str   'Splash3Data data'
PackSize       str   'Splash3PackSize dc i''$'
SizeStr        str   '0000'''
Label1         str   'PackedSplash3 anop'
EndStr         str   ''''
DoneStr        str   ' end'
LineStr        str   ' dc h'''
HexStr         str   '00'
PalStr         str   'Splash3Pal anop'
