...
; Compress the data
;
               Packbytes (#start,#length,#data,#160*35),PackLen
;
...
SplashStr      str   'Splash1Data data'
PackSize       str   'Splash1PackSize dc i''$'
SizeStr        str   '0000'''
Label1         str   'PackedSplash1 anop'
EndStr         str   ''''
DoneStr        str   ' end'
LineStr        str   ' dc h'''
HexStr         str   '00'
PalStr         str   'Splash1Pal anop'
