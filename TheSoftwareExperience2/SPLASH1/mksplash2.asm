...
; Compress the data
;
               Packbytes (#start,#length,#data,#160*26),PackLen
;
...
SplashStr      str   'Splash2Data data'
PackSize       str   'Splash2PackSize dc i''$'
SizeStr        str   '0000'''
Label1         str   'PackedSplash2 anop'
EndStr         str   ''''
DoneStr        str   ' end'
LineStr        str   ' dc h'''
HexStr         str   '00'
PalStr         str   'Splash2Pal anop'
