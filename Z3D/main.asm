...
main           START
	...
	using	drawdat
               ...
               ld2   100,PerspD
;               ld4   +$00008000,(ScaleX,ScaleY,ScaleZ)
...
drawit         and   #$0F
               ...
               mv2   "numtbl+0,y",">$e12000+160*0,x"
               mv2   "numtbl+2,y",">$e12000+160*1,x"
               mv2   "numtbl+4,y",">$e12000+160*2,x"
               mv2   "numtbl+6,y",">$e12000+160*3,x"
               mv2   "numtbl+8,y",">$e12000+160*4,x"
               mv2   "numtbl+10,y",">$e12000+160*5,x"
               mv2   "numtbl+12,y",">$e12000+160*6,x"
